...
const SCENE_3_DURATION = 45;   // "INSANELY HARD." perspective zoom (+200ms breathing)
const SCENE_4_DURATION = 38;   // Purple morph + "What if you could" overlap (+200ms)
const SCENE_5_DURATION = 24;   // "What if you could" hold (+200ms)
const SCENE_6_DURATION = 53;   // "spot" with arrows (+200ms)
const SCENE_7_DURATION = 56;   // "exactly what your customers" (+200ms)
const SCENE_8_DURATION = 19;   // "are searching for," (+200ms)
const SCENE_9_DURATION = 60;   // Search bar typing + zoom (+200ms)
const SCENE_10_DURATION = 3;   // Transition to black (unchanged)
const SCENE_11_DURATION = 24;  // Purple "!" rotating (+200ms)
const SCENE_12_DURATION = 28;  // "meet!" bouncy purple → morphs white + straightens (+200ms)
const SCENE_13_DURATION = 1;   // Brief hold (unchanged)
const SCENE_14_DURATION = 20;  // Neon pill drawing (+200ms)
const SCENE_15_DURATION = 60;  // "OUTRANK" in neon pill (+200ms)
const SCENE_16_DURATION = 5;   // Neon pill fade (unchanged)
const SCENE_17_DURATION = 48;  // "Scale your" + "traffic on autopilot." (+200ms)
...
const SCENE_24_DURATION = 1;   // REMOVED: calendar zoom (kept 1 frame minimum)
...
const SCENE_32_DURATION = 40;   // Floating article cards — cards land then straight to zoom
const SCENE_33_DURATION = 32;   // Article cards zoom with radial blur → white
const SCENE_34_DURATION = 75;   // Content History table on purple (3D tilt + scroll)
const SCENE_35_DURATION = 70;   // "Come back tomorrow to see your article" word reveal
const SCENE_36_DURATION = 24;   // "PUBLISHED" quick pop on white + 300ms hold
